package com.fjrcloud.lin.receiver;
...
//            Utils.showToast(context, context.getString(R.string.device_is_added, deviceId));
            ...
            Intent toIntent = new Intent(context, VideoActivity.class);
...
//            com.videogo.ui.androidpn.NotifierUtils.showNotification(context, intent);
//        }
    }
